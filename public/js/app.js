...
function updateCart(foowings) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', foowings).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var foowings = JSON.parse(btn.dataset.foowings);
    updateCart(foowings);
  });
});
...
__webpack_require__(/*! D:\node e-comm project\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\node e-comm project\resources\scss\app.scss */"./resources/scss/app.scss");
